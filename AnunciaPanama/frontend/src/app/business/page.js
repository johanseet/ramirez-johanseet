  ...
  const plans = [
    {
      name: 'Freemium',
      price: 'Gratis',
      description: 'Crear hasta 3 anuncios al mes.',
      features: [
        'Acceso básico a estadísticas de rendimiento',
        'Segmentación básica por edad y género',
    ...
    },
    {
      name: 'Básico',
      price: '$10/mes',
      description: 'Ideal para pequeñas empresas que desean aumentar su visibilidad.',
      features: [
        'Crear hasta 10 anuncios al mes',
        'Acceso a estadísticas detalladas',
        'Segmentación avanzada por edad, género, ubicación e intereses',
        'Soporte prioritario vía correo electrónico y chat',
      ],
    },
    {
      name: 'Profesional',
      price: '$30/mes',
      description: 'Para empresas que desean maximizar su alcance y optimización.',
      features: [
        'Crear anuncios ilimitados',
        'Acceso completo a estadísticas con informes descargables',
        'Segmentación avanzada y retargeting',
        'Análisis de competencia y recomendaciones para optimización',
        'Soporte premium vía correo electrónico, chat y teléfono',
      ],
    },
    {
      name: 'Premium',
      price: '$50/mes',
      description: 'Para grandes empresas con necesidades avanzadas de marketing.',
      features: [
        'Mayor visibilidad en la plataforma',
        'Anuncios destacados',
        'Herramientas de A/B testing',
        'Consultoría mensual con un experto en marketing digital',
        'Integraciones con herramientas externas de análisis',
      ],
    },
  ];
