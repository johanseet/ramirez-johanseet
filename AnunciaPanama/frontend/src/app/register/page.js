...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/auth/register/client`, dataToSend);
    ...
    <SimpleLayout>
      <div className="bg-gray-50 flex flex-col justify-center min-h-screen sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <img className="mx-auto h-40 w-auto" src="/logo.svg" alt="Logo de la empresa" />
