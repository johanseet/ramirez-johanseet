//AnunciaPanama/anuncia-panama-frontend/src/components/navigation/Navbar.js
"use client";
...
const Navbar = () => {
  ...
  const navigation = [
    { name: 'Comercios', href: routes.business.home, current: false },
  ];
                ...
                <div className="hidden sm:ml-6 sm:flex items-center space-x-4">
                  ...
                  {user && (
                    <>
                      <button
                        type="button"
                        className="text-white hover:text-gray-200 cursor-pointer flex items-center ml-4"
